...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<!-- theme_path -->/css/rewrite.css" />
        <!-- additional_styles -->
        <!-- additional_scripts -->
    ...
    <body>
        <div id="page-container" class="container-fluid bg-white">
            ...
            <div class="row content">
                ...
                <aside id="page-aside-content" class="container col-sm-3 well bg-3"><!-- page_aside_content --></aside>
            </div>
            <footer id="page-footer" class="footer bg-2"><!-- page_footer --></footer>
        </div>
